resource "fortios_vpnipsec_phase1interface" "to-Azure" {
  acct_verify               = "disable"
  ...
  interface                 = "port1" # update outside interface
  ip_version                = "4"
  ...
  name                      = "to-Azure" #update interface name
  nattraversal              = "enable"
  negotiate_timeout         = 30
  net_device                = "enable" #update to enable
  passive_mode              = "disable"
  peertype                  = "any"
  ppk                       = "disable"
  priority                  = 0
  proposal                  = "aes128-sha256 aes256-sha256 aes128-sha1 aes256-sha1"
  psksecret                 = var.PSK #update psk
  reauth                    = "disable"
  rekey                     = "enable"
  remote_gw                 = var.remote_gw #update Remote GW 
  remote_gw6                = "::"
...
resource "fortios_vpnipsec_phase2interface" "to-Azure" {
  add_route                = "phase1"
  auto_discovery_forwarder = "phase1"
  auto_discovery_sender    = "phase1"
  auto_negotiate           = "enable" #make it enable
  dhcp_ipsec               = "disable"
  dhgrp                    = "14 5"
  ...
  name                     = "to-Azure" #update interface name 
  pfs                      = "enable"
  phase1name               = fortios_vpnipsec_phase1interface.to-Azure.name #Update Phase1 name
