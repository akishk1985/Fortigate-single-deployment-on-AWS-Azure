resource "fortios_vpnipsec_phase1interface" "to-AWS" {
  acct_verify               = "disable"
  ...
  name                      = "to-AWS" #update interface name
  nattraversal              = "enable"
...
resource "fortios_vpnipsec_phase2interface" "to-AWS" {
  add_route                = "phase1"
  ...
  name                     = "to-AWS" #update interface name 
  pfs                      = "enable"
  phase1name               = fortios_vpnipsec_phase1interface.to-AWS.name #Update Phase1 name
